...
public class DocumentTests {
    ...
    public void testEURTargetSameAsCurrentOne() {
        ...
        BigDecimal result = invoice.calculateExchangedAmount(exchangeRates,
                CurrencyType.EUR);

        Assertions.assertEquals(
                BigDecimal.valueOf(100.50).setScale(2, RoundingMode.HALF_UP),
                result,
    ...
    public void testGBRTargetAndDefaultOne() {
        Document invoice = new Invoice(1, 100, CurrencyType.EUR, 0);
        Map<CurrencyType, Double> rates = new HashMap<>();
        rates.put(CurrencyType.GBP, 1.0);
    ...
    public void testGBRTargetEURCurrentUSDDefalt() {
        Document invoice = new Invoice(1, 1500.23, CurrencyType.EUR, 0);
        Map<CurrencyType, Double> rates = new HashMap<>();
        rates.put(CurrencyType.USD, 1.0);
        rates.put(CurrencyType.GBP, 0.7587277);
